		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#projectoholamundo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectoholamundo-display": {
								"semanticObject": "projectoholamundo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectoholamundo",
									"url": sap.ui.require.toUrl("projectoholamundo")
								}
							}
						}
					}
